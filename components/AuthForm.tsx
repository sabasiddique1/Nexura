...
const AuthForm = ( {type}: { type: string }) => {
    ...
    const onSubmit = async (data: z.infer<typeof formSchema>)=> {
        ...
        try {
            //sign up with appwrite and create palsid token
            ...
            <header className="flex flex-col gap-5 md:gap-8">
                <Link href="/" className="cursor-pointer flex items-center gap-1">
                    <Image
                        ...
                        alt="Nexura logo"
                    />
                    <h1 className="text-26 font-ibm-plex-serif font-bold text-black-1">Nexura</h1>
                </Link>
                            ...
                            {type === 'sign-up' && (
                                <>
                                    <div className="flex gap-4">
                                        <CustomInput control={form.control} name="firstName" label="First Name" placeholder="Enter the first name" type="text"/>
                                        <CustomInput control={form.control} name="lastName" label="Last Name" placeholder="Enter the last name" type="text"/>
                                    </div>
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <CustomInput control={form.control} name="postalCode" label="Postal Code" placeholder="Example: 45560" type="text"/>
                                    </div>
                                    <div className="flex gap-4">
